...
void GreaterThan::generate(AssemblyProgram &ap) const
{
    ...
    ap.addLine("    mov eax, 0");   // Zero eax, becuase setg only affects one byte
    ap.addLine("    setg al");     // If ecx > eax, set to 1, otherwise 0
}
